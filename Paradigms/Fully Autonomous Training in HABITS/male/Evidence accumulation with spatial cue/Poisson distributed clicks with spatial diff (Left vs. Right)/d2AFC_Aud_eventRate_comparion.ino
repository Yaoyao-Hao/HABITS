...
int CatchTrialProb = 5; // use a small number of trials as catch trials
...
void construct_matrix_and_Run()
{
  ...
  /*********************CatchTrial************************/
  if (S.currProtocolIndex >= 3) // test protocol
  {
    S.SamplePeriod = int(random(1 ,11)) * 100;
    
  }
  NoOutputBinNum = SampleBinNum - int(S.SamplePeriod / 25);
  /*******************************************************/
  ...
  int EventRate = 0; // using the real EventRate that presented to mice to judge the correct choice.
    ...
    OutputAction SamplePeriod10_Output[3] = {OutputL[BinaryClickLeft[10]], OutputR[BinaryClickRight[10]], AudOutput[BinaryClick[10]]};
    OutputAction SamplePeriod11_Output[3] = {OutputL[BinaryClickLeft[11]], OutputR[BinaryClickRight[11]], AudOutput[BinaryClick[11]]};
    OutputAction SamplePeriod12_Output[3] = {OutputL[BinaryClickLeft[12]], OutputR[BinaryClickRight[12]], AudOutput[BinaryClick[12]]};
    OutputAction SamplePeriod13_Output[3] = {OutputL[BinaryClickLeft[13]], OutputR[BinaryClickRight[13]], AudOutput[BinaryClick[13]]};
    OutputAction SamplePeriod14_Output[3] = {OutputL[BinaryClickLeft[14]], OutputR[BinaryClickRight[14]], AudOutput[BinaryClick[14]]};
    OutputAction SamplePeriod15_Output[3] = {OutputL[BinaryClickLeft[15]], OutputR[BinaryClickRight[15]], AudOutput[BinaryClick[15]]};
    OutputAction SamplePeriod16_Output[3] = {OutputL[BinaryClickLeft[16]], OutputR[BinaryClickRight[16]], AudOutput[BinaryClick[16]]};
    OutputAction SamplePeriod17_Output[3] = {OutputL[BinaryClickLeft[17]], OutputR[BinaryClickRight[17]], AudOutput[BinaryClick[17]]};
    OutputAction SamplePeriod18_Output[3] = {OutputL[BinaryClickLeft[18]], OutputR[BinaryClickRight[18]], AudOutput[BinaryClick[18]]};
    OutputAction SamplePeriod19_Output[3] = {OutputL[BinaryClickLeft[19]], OutputR[BinaryClickRight[19]], AudOutput[BinaryClick[19]]};
    OutputAction SamplePeriod20_Output[3] = {OutputL[BinaryClickLeft[20]], OutputR[BinaryClickRight[20]], AudOutput[BinaryClick[20]]};
    OutputAction SamplePeriod21_Output[3] = {OutputL[BinaryClickLeft[21]], OutputR[BinaryClickRight[21]], AudOutput[BinaryClick[21]]};
    OutputAction SamplePeriod22_Output[3] = {OutputL[BinaryClickLeft[22]], OutputR[BinaryClickRight[22]], AudOutput[BinaryClick[22]]};
    OutputAction SamplePeriod23_Output[3] = {OutputL[BinaryClickLeft[23]], OutputR[BinaryClickRight[23]], AudOutput[BinaryClick[23]]};
    OutputAction SamplePeriod24_Output[3] = {OutputL[BinaryClickLeft[24]], OutputR[BinaryClickRight[24]], AudOutput[BinaryClick[24]]};
    OutputAction SamplePeriod25_Output[3] = {OutputL[BinaryClickLeft[25]], OutputR[BinaryClickRight[25]], AudOutput[BinaryClick[25]]};
    OutputAction SamplePeriod26_Output[3] = {OutputL[BinaryClickLeft[26]], OutputR[BinaryClickRight[26]], AudOutput[BinaryClick[26]]};
    OutputAction SamplePeriod27_Output[3] = {OutputL[BinaryClickLeft[27]], OutputR[BinaryClickRight[27]], AudOutput[BinaryClick[27]]};
    OutputAction SamplePeriod28_Output[3] = {OutputL[BinaryClickLeft[28]], OutputR[BinaryClickRight[28]], AudOutput[BinaryClick[28]]};
    OutputAction SamplePeriod29_Output[3] = {OutputL[BinaryClickLeft[29]], OutputR[BinaryClickRight[29]], AudOutput[BinaryClick[29]]};
    OutputAction SamplePeriod30_Output[3] = {OutputL[BinaryClickLeft[30]], OutputR[BinaryClickRight[30]], AudOutput[BinaryClick[30]]};
    OutputAction SamplePeriod31_Output[3] = {OutputL[BinaryClickLeft[31]], OutputR[BinaryClickRight[31]], AudOutput[BinaryClick[31]]};
    OutputAction SamplePeriod32_Output[3] = {OutputL[BinaryClickLeft[32]], OutputR[BinaryClickRight[32]], AudOutput[BinaryClick[32]]};
    OutputAction SamplePeriod33_Output[3] = {OutputL[BinaryClickLeft[33]], OutputR[BinaryClickRight[33]], AudOutput[BinaryClick[33]]};
    OutputAction SamplePeriod34_Output[3] = {OutputL[BinaryClickLeft[34]], OutputR[BinaryClickRight[34]], AudOutput[BinaryClick[34]]};
    OutputAction SamplePeriod35_Output[3] = {OutputL[BinaryClickLeft[35]], OutputR[BinaryClickRight[35]], AudOutput[BinaryClick[35]]};
    OutputAction SamplePeriod36_Output[3] = {OutputL[BinaryClickLeft[36]], OutputR[BinaryClickRight[36]], AudOutput[BinaryClick[36]]};
    OutputAction SamplePeriod37_Output[3] = {OutputL[BinaryClickLeft[37]], OutputR[BinaryClickRight[37]], AudOutput[BinaryClick[37]]};
    OutputAction SamplePeriod38_Output[3] = {OutputL[BinaryClickLeft[38]], OutputR[BinaryClickRight[38]], AudOutput[BinaryClick[38]]};
    OutputAction SamplePeriod39_Output[3] = {OutputL[BinaryClickLeft[39]], OutputR[BinaryClickRight[39]], AudOutput[BinaryClick[39]]};
    ...
    states[11] = smart.CreateState("SamplePeriod2", PulseTime * sample_bin, 1, SamplePeriod2_Cond, 3, SamplePeriod2_Output);
  ...
  {       // teach animal to lick according to cue
    ...
    int P_value = int(1000 * PoissonRate / SampleBinNum);
    for (int i = 0; i < 40; i ++)
    {
      if(i < NoOutputBinNum)
      {
      ...
      {
        if (int(random(1000)) < P_value || i == NoOutputBinNum) // using 1000 as the cardinal number to increase resolution of P_value
        {
          if(TrialType == 1)
          {
            BinaryClickRight[i] = 0;
  ...
  break;
  // Protocol 3: full protocol training mice to report the orientation which had presented the greater total number of clicks (100-1000 sample period + 4 trial types with different levels of difficulty )
  case 3: //  antiBias 
  case 4: //  antiBias
  case 5: //  antiBias
  case 6: //  antiBias
  case 7: //  antibias retention period
  case 8: //  test protocol
  {       
    OutputAction SampleOutputL;
    OutputAction SampleOutputR;
    OutputAction AudSampleOutput;
    ...
    AudSampleOutputBackground = {"Flag3", 0}; // no output
    SampleOutputBackgroundL = LeftAudOutputBackground;
    SampleOutputBackgroundR = LeftAudOutputBackground;
    ...
    // difficulty selection  39:1 ;37:3 ;31:9 ;26:14
    difficultLevel = int(random(4));
...
void autoChangeProtocol()
{
  ...
  {
  case 0:
    if (S.currProtocolTrials > 1500 && Perf100 > 75)
