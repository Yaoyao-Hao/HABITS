...
void construct_matrix_and_Run()
{
  ...
  {                        
    ...
    StateTransition GiveFreeDrop_Cond[1] = {{"Tup", "exit"}};
    StateTransition NoResponse_Cond[3] = {{"Lick1In", "exit"}, {"Lick2In", "exit"}, {"Tup", "exit"}};
    StateTransition AnswerPeriod_Cond[3]   = {{"Lick1In", "GiveFreeDropLeft"}, {"Lick2In", "GiveFreeDropRight"}, {"Tup", "NoResponse"}};
    
    OutputAction Reward_OutputLeft[1] = {LeftWaterOutput};
    OutputAction Reward_OutputRight[1] = {RightWaterOutput};
    OutputAction NoOutput[0] = {};
    
    gpSMART_State states[4] = {};
    states[0] = smart.CreateState("Answerperiod", 5000, 3, AnswerPeriod_Cond, 0, NoOutput);
    states[1] = smart.CreateState("GiveFreeDropLeft", reward_dur, 1, GiveFreeDrop_Cond, 1, Reward_OutputLeft);
    states[2] = smart.CreateState("GiveFreeDropRight", reward_dur, 1, GiveFreeDrop_Cond, 1, Reward_OutputRight);
    states[3] = smart.CreateState("NoResponse", random(30, 60) * 60 * 1000, 3, NoResponse_Cond, 0, NoOutput); // 1-hr: 60*60*1000 msec
